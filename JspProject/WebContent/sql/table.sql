...
create table okky_board(
    ...
    board_comment number(5) default 0,		-- 게시글 댓글 수
...
create table okky_company(
	...
	company_license_num varchar2(100) not null,		-- 회사 사업자 등록번호
	...
	company_emp varchar2(100),				        -- 회사 직원 수
...
create table okky_job(
    ...
    job_contract number(5) not null,       -- 구인 계약형태(0:정규직/1:계약직)
