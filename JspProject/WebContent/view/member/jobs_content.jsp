			...
			<div style="width: 805px; min-height: 800px;">
				...
				<div class="cont">
					<table class="table table-bordered">
						...
						<tr>
							<td class="col-md-10"><span class="cont-title">${dto.gettitle() }</span>
								<div class="com-content">
									...
									<p>
										<b>직무 : </b>${dto.getdoing }</p>
									<p>
										<b>경력 : </b>${dto.getjob_mincareer() }년 이상 ~
										${dto.getjob_maxcareer() }년 이하
									</p>
									<p>
										<b>급여 : </b>${dto.getjob_mincost }만 이상 ~ ${dto.getjob_maxcost }만
										미만
									</p>
									...
									<p>
										<b>담당자명 : </b>${dto.getcompany_charge_name }</p>
									<p>
										<b>이메일 : </b>${dto.getcompany_charge_email }</p>
									<p>
										<b>연락처 : </b>${dto.getcompany_charge_phone }</p>
								</div></td>
							...
							<td class="col-md-2">
								<div class="cont-like text-center">
									...
									<c:if test="${loginNum == dto.getBoard_writer() }">
											<!-- 자신이 작성한 게시물일 경우 -->
											<div class="com-edit dropdown">
												<button class="com-edit-btn btn dropdown-toggle"
												...
												<ul class="dropdown-menu" role="menu"
													...
													<li role="presentation"><a role="menuitem"
														tabindex="-1"
														href="<%=request.getContextPath() %>/member_board_delete.do?num=${dto.getBoard_num()}&big=${big_category}&small=${small_category}&cate_num=${category.getCate_num()}"
														onclick="return confirm('게시물을 삭제 하시겠습니까?');"> <i
															class="fas fa-trash-alt"></i>&nbsp;삭제
													</a></li>
												</ul>
											</div>
											<div class="buttons-${dto.getBoard_num() }"
												style="display: none;" align="center">
												<p>
													<input type="button"
														class="btn btn-default btn-wide note-edit-cancel-btn"
														onclick="return commentEditCancle${dto.getBoard_num()}()"
														value="취소">
												</p>
												<p>
						...
						<tr>
							...
							<td class="col-xs-9">
								<h2>
									<a
										href="<%=request.getContextPath()%>/view/member/company_content.jsp">
										<span class="company-name">${dto.getcompany_name }</span>
									</a>
								</h2> <a href="(회사 홈페이지)"><span class="company-homepage">${dto.getcompany_homepage }</span></a>
								<hr>
								<p class="company-content">${dto.getcompany_content }</p>
							</td>
						</tr>
					</table>
				</div>
