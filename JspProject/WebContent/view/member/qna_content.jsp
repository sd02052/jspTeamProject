							...
							<div class="comment">
								<table class="table table-bordered">
									...
									<tr>
										<td class="col-md-10">
											<a href="">
												<img src="<%=request.getContextPath() %>/images/profile00.png" class="qna-logo img-circle"></a>
											<a href="<%=request.getContextPath()%>/view/member/member_personal.jsp">
												<img src="<%=request.getContextPath() %>/images/profile00.png" class="mem_logo_cont img-circle"></a>
									...
									<tr>
										<td colspan="10">
											<form method="post" action="">
												<img src="<%=request.getContextPath() %>/images/comment_logo.png" class="comment-logo img-circle">
													<a href="<%=request.getContextPath()%>/view/member/member_personal.jsp">
														<img src="<%=request.getContextPath() %>/images/profile00.png" class="mem_logo_cont img-circle"></a>
													<a href="<%=request.getContextPath()%>/view/member/member_personal.jsp">(로그인 닉네임)</a>
													(활동점수)<br><br>
