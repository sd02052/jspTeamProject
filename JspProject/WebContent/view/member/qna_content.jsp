					...
					<div style="width: 805px; min-height: 800px;">
						...
						<div id="article" class="div">
							...
							<div class="nav">		
								...
								onclick="location.href='<%=request.getContextPath()%>/view/member/qna_write'">
								...
								<table class="table table-bordered">
									...
									<tr>
										<td class="col-md-10">
											<div class="cont-member pull-left">
												<a href="#">
													<img src="<%=request.getContextPath() %>/images/com_selected.png" class="cont-mem-logo img-circle"></a>
												<a href="<%=request.getContextPath()%>/view/member/member_personal.jsp">
									...
									<tr>
										<td class="col-md-10">
											<div class="cont-member pull-left">
												<a href="#">
													<img src="<%=request.getContextPath() %>/images/com_select.png" class="cont-mem-logo img-circle"></a>
												<a href="<%=request.getContextPath()%>/view/member/member_personal.jsp">
													<img src="<%=request.getContextPath() %>/images/profile00.png" class="cont-mem-logo img-circle"></a>
									...
									<tr>
										<td colspan="10">
											<form method="post" action="">
												...
												<div class="cont-member pull-left">
													<a href="#">
															<img src="<%=request.getContextPath() %>/images/comment_logo.png" class="cont-mem-logo img-circle"></a>
													<a href="<%=request.getContextPath()%>/view/member/member_personal.jsp">
														<img src="<%=request.getContextPath() %>/images/profile00.png" class="cont-mem-logo img-circle"></a>
