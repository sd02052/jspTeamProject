						...
						<form method="post" action="<%=request.getContextPath()%>/member_qna_search.do">
							<div class="category-filter-wrapper">
								...
								<div class="category-filter-query pull-right">
									<div class="input-group input-group-sm">
										...
										<span class="input-group-btn">
											...
											<button type="submit" class="btn btn-warning" onclick="moveBoard()">
								...
								<ul class="list-sort pull-left">
									<li><a href="<%=request.getContextPath() %>/member_qna_search.do?cate_num=${cate_num}&big=${big_category}&small=${small_category}&cate_group=${cate_group}&cate_step=${cate_step}&data=${data }" id="sort-date">최신순</a></li>
									<li><a href="<%=request.getContextPath() %>/member_qna_search_list_sort.do?sort=<%=like %>&cate_num=${cate_num}&big=${big_category}&small=${small_category}&cate_group=${cate_group}&cate_step=${cate_step}&data=${data }" id="sort-like">추천순</a></li>
									<li><a href="<%=request.getContextPath() %>/member_qna_search_list_sort.do?sort=<%=comment %>&cate_num=${cate_num}&big=${big_category}&small=${small_category}&cate_group=${cate_group}&cate_step=${cate_step}&data=${data }" id="sort-comment">댓글순</a></li>
									<li><a href="<%=request.getContextPath() %>/member_qna_search_list_sort.do?sort=<%=scrap %>&cate_num=${cate_num}&big=${big_category}&small=${small_category}&cate_group=${cate_group}&cate_step=${cate_step}&data=${data }" id="sort-scrap">스크랩순</a></li>
									<li><a href="<%=request.getContextPath() %>/member_qna_search_list_sort.do?sort=<%=hit %>&cate_num=${cate_num}&big=${big_category}&small=${small_category}&cate_group=${cate_group}&cate_step=${cate_step}&data=${data }" id="sort-hit">조회순</a></li>
								</ul>
							</div>
						</form>
					</div>
							...
							<div align="center">
							  ...
							  <c:if test="${page > 1 }">
							   ...
							   <c:if test="${page eq 1 }">
							    ...
							    <c:forEach begin="${startBlock }" end="${endBlock }" var="i">
								    <c:if test="${i == page }">
								   		<li class="active"><a href="member_qna_search_list_sort.do?page=${i }&sort=<%=comment %>&cate_num=${cate_num }&big=${big_category }&small=${small_category }&cate_group=${cate_group}&cate_step=${cate_step}&data=${data }">${i }</a></li>
								    </c:if>
